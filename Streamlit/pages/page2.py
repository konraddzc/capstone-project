...
if run:
    try:
        ...
        # Handle manually pasted text
            ...
            if txt_manual && txt_manual.strip():
        ...
        if txt:
            ...
            # TAB: HTML explanation with downloadable formats
            with tab_highlights:
                st.subheader("Highlighted explanation")
                # Render the explanation HTML within an iframe
                components.html(html, height=900, scrolling=True)

                col_html, col_pdf = st.columns(2)

                # Download button for raw HTML explanation
                with col_html:
                    st.download_button(
                ...
                # Attempt to render HTML to PDF if xhtml2pdf is available
                pdf_bytes = None
                try:
                ...
                # Download button for PDF explanation (if generation succeeded)
                if pdf_bytes:
                    with col_pdf:
                        st.download_button(
